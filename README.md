...
[![JavaDoc](https://img.shields.io/badge/javadoc-2.2.0-brightgreen.svg)](http://www.javadoc.io/doc/com.github.elopteryx/upload-parser)
...
-----
```xml
compile "com.github.elopteryx:upload-parser:2.2.0"
```

If you want parameter injection for your JAX-RS endpoints:

```xml
compile "com.github.elopteryx:upload-parser-jaxrs:2.2.0"
```
Maven
-----
```xml
...
[1]: http://www.javadoc.io/doc/com.github.elopteryx/upload-parser/2.2.0
[2]: http://www.javadoc.io/doc/com.github.elopteryx/upload-parser-jaxrs/2.2.0
