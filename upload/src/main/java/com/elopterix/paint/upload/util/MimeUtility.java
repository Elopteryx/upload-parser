        ...
        try {
            ...
            switch (encoding) {
                case BASE64_ENCODING_MARKER:
                    decodedData = Base64.getMimeDecoder().decode(encodedData);
                    break;
                case QUOTED_PRINTABLE_ENCODING_MARKER:  // maybe quoted printable.
                    decodedData = QuotedPrintableDecoder.decode(encodedData);
                    break;
                default:
